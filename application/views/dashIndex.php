                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800 clock"></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php  $v=0;foreach($pendingShow->result() as $row){
                if ($row->confirm==0) { $v+=1 ;}};
                echo $v;
              ?></div>
                    </div>
                    <div class="col-auto">
